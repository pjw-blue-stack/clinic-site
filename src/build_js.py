...
base_data = [
  {
    ...
    "sixSteps": {
      ...
      "timeline": {
        "title": "치료 예후 및 기간",
        "steps": [
          { "step": "1단계", "period": "1~4주", "desc": "체내 갇힌 열독 및 독소 집중 배출" },
          { "step": "2단계", "period": "2~3개월", "desc": "자율신경계 안정 및 코어 체질 개선" },
          { "step": "3단계", "period": "유지기", "desc": "튼튼한 면역력(위기) 재건으로 요요 방지" }
        ]
      },
      "pricing": {
        "title": "진료 비용 안내",
        "description": "1개월 집중 해독 패키지: 월 40만 원대부터~",
        "subtext": "(환자의 체질과 병의 깊이에 따라 1:1 맞춤 조제되어 비용이 달라질 수 있습니다.)",
        "btnText": "💬 내 맞춤 비용 알아보기 (카톡)"
      }
    }
  },
  {
