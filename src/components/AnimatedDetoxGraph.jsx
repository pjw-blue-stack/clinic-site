...
export default function AnimatedDetoxGraph() {
  ...
  // Markers Opacity
  const startMarkerOpacity = useTransform(scrollYProgress, [0.15, 0.25, 1], [0, 1, 1]);
  const startMarkerY = useTransform(scrollYProgress, [0.15, 0.25], [20, 0]);
  
  const endMarkerOpacity = useTransform(scrollYProgress, [0.65, 0.75, 1], [0, 1, 1]);
  const endMarkerY = useTransform(scrollYProgress, [0.65, 0.75], [20, 0]);
  
  const finishMarkerOpacity = useTransform(scrollYProgress, [0.85, 0.95], [0, 1]);
