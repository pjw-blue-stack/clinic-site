...
pages = [
    ...
    },
    {
        "title": "09. 치료후기",
        "sections": [
            {"title": "1. 문제 인식 & 공감", "desc": "[카피] 수많은 병원 쇼핑과 부작용 끝에 찾아온 분들의 이야기\n- 비주얼: 절망했던 환자들이 치료 전 남긴 고민 글 캡처 (공감)"},
            {"title": "2. 가치 입증 & 권위", "desc": "[카피] 조작 없는 100% 자필 후기와 14년 3,800명의 누적 데이터\n- 비주얼: 병원 로비에 빼곡히 쌓인 자필 후기 차트 사진"},
            {"title": "3. 패러다임 전환", "desc": "[카피] '다한증은 불치병'이라는 상식을 깬 사람들의 갤러리\n- 비주얼: 부위별(손발, 전신, 머리 등) 치료 성공 인터뷰 영상/글"},
            {"title": "4. 솔루션 제시 (장기 유지 증명)", "desc": "[카피] 1년이 아니라 10년이 지나도 요요 없이 쾌적한 30대 남성\n- 비주얼: 내성이나 재발이 없는 해독 원리의 결과 증명 (타임라인)"},
            {"title": "5. 반박 제거", "desc": "[카피] 이 후기들이 가짜일까 의심되시나요? 직접 확인해 보세요.\n- 기능: 의료법 준수 로그인 후기 게시판 구조 안내"},
            {"title": "6. 행동 유도", "desc": "[카피] 나와 똑같은 증상을 검색해 보고, 희망을 얻으셨다면 상담하세요.\n- 기능: [검색창 UI] 및 [나도 후기의 주인공 되기 - 예약] 버튼"}
        ]
    },
    {
        "title": "10. 한의원 소개 (경희정원)",
        "sections": [
            {"title": "1. 문제 인식 & 공감", "desc": "[카피] 아직도 땀구멍만 막는 얕은 치료에 시간과 돈을 허비하시나요?\n- 비주얼: 표면적인 치료의 한계 지적 (공감대 형성)"},
            {"title": "2. 가치 입증 & 권위", "desc": "[카피] 몸속의 불을 끄는 근본 원리 하나에 14년을 매달렸습니다.\n- 비주얼: 박제욱 원장님의 전문성, 경력, 연구 및 진료 철학"},
            {"title": "3. 패러다임 전환 (시스템)", "desc": "[카피] 대인기피증 환자도 안심하는 1:1 프라이빗 예약제 진료\n- 비주얼: 번잡한 공장형 병원이 아닌, 오직 한 분을 위한 시원한 프라이빗 진료실"},
            {"title": "4. 솔루션 제시 (투명성)", "desc": "[카피] 내 가족이 먹을 수 없다면 달이지 않습니다. 청정 약재 관리\n- 비주얼: 정원해독탕 조제실 전경, 식약처 인증 안전 한약재 이미지"},
            {"title": "5. 반박 제거", "desc": "[카피] 한약 먹으면 간 나빠진다? 속을 편안하게 씻어내는 독소 0% 정화약\n- 기능: 한약 안전성 검사 결과표 등 객관적 지표 제시"},
            {"title": "6. 행동 유도", "desc": "[카피] 환자분의 소중한 걸음이 헛되지 않도록 최선을 다하겠습니다.\n- 기능: 약도/교통편, 진료 시간, [카카오톡 실시간 상담] 버튼"}
        ]
    }
]
...
print("Generated 00_다한증_전체_설계도_6단계.excalidraw with 10 pages, 6 steps each.")
